...
import (
	...
	"greenlight.qliso.net/internal/mailer"
	"greenlight.qliso.net/internal/vcs"
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "b7d201885df149", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "9c07643b812bf5", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.qliso.net>", "SMTP sender")
