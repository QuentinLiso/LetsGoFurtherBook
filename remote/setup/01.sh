...
# A full list of available timezones can be found by running timedatectl list-timezones
...
# Add a DSN for connecting to the DB to the system-wide environment variables in the /etc/environment file
...
# --force-confnew flag means that config files will be replaced if newer ones are available
